...
const ShoppingCart = () => {
  ...
  const handleRemoveFromCart = (itemId) => {
    warningMessage1(
      "Are you sure?",
      "Once confirmed the selected item will no longer be available in your cart!",
      () => {
  ...
  const handleResetCart = () => {
    warningMessage2(
      "Are you sure?",
      "Once confirmed all items in the cart will be removed!",
      () => {
        resetCart();
        Toast({ type: "success", message: "Cart is reset" });
      }
    );
  };
        ...
        {cartItems.length > 0 ? (
          <>
            <div style={{ alignItems: "center", padding: "0px 60px" }}>
              <table style={{ width: "100%" }} className="tabl">
                <thead>
                  <tr
                    style={{
                      color: "black",
